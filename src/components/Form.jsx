    ...
    return (
        <form className="p-6" action={handleSubmit}>
            ...
            <div className="flex flex-col pb-4">
                ...
                <div className="flex items-center justify-between border-1 border-gray-400 h-12 overflow-hidden rounded-[0.5rem]">
                    <input type="text" className="border-none text-[#2c414c] text-xl px-4 h-full w-full"/>
            ...
            <div>
                ...
                <div className="border-1 border-gray-400 h-12  rounded-[0.5rem]  mb-6 flex gap-2 items-center px-4">
